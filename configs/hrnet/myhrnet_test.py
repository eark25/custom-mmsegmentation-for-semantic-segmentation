...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=None, multiscale_mode='range', ratio_range=(0.5, 2.0), keep_ratio=True),
...
# optimizer
optimizer = dict(type='SGD', lr=1e-2, momentum=0.9, weight_decay=1e-8)
optimizer_config = dict(type='GradientCumulativeOptimizerHook', cumulative_iters=4)

# learning policy
lr_config = dict(policy='poly', power=0.9, min_lr=1e-2, by_epoch=True)
