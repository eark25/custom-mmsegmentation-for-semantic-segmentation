...
work_dir = '/root/mmsegmentation/hrnet_last_run_icy'
...
log_config = dict(interval = 1,
    hooks=[
        ...
        dict(type='WandbLoggerHook',  by_epoch=True, init_kwargs=dict(project='hrnet_last_run_icy', resume='allow', anonymous='must'))
    ])
