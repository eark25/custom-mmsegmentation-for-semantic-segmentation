...
work_dir = '/root/mmsegmentation/hrnet_next_sweep'
...
log_config = dict(interval = 151,
    hooks=[
        ...
        dict(type='WandbLoggerHook',  by_epoch=True, init_kwargs=dict(project='hrnet_next_sweep', resume='allow', anonymous='must'))
    ])
