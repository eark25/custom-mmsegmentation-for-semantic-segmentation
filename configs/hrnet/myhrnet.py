...
work_dir = '/root/mmsegmentation/hrnet_last_run_bg'
...
log_config = dict(interval = 1,
    hooks=[
        ...
        dict(type='WandbLoggerHook',  by_epoch=True, init_kwargs=dict(project='hrnet_last_run_bg', resume='allow', anonymous='must'))
    ])
