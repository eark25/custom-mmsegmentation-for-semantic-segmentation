...
def main():
    ...
    cfg = Config.fromfile('../configs/unet/myunet.py')
    ...
    cfg.work_dir = '/root/mmsegmentation/unet_imgnet_CLAHE3_run_001'

    print(cfg.pretty_text)

    cfg.dump('/root/mmsegmentation/configs/unet/myunet_imgnet_CLAHE_test.py')
